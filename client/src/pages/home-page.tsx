              ...
              <h1 className="text-4xl lg:text-6xl font-bold mb-6">
                {t("hero.title")
                  ...
                  .map((word, index) => (
                    <span
                      key={index}
                      className={word === "Rural" ? "text-white" : ""}
                    >
                      {word}{" "}
                    </span>
                  ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Comprehensive tools and resources designed for rural community
              empowerment
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <Card className="card-hover">
              <CardContent className="p-6">
                ...
                <p className="text-slate-600 mb-4">
                  Interactive video lessons on government schemes, banking,
                  agriculture, and health with bilingual support.
                </p>
            ...
            <Card className="card-hover">
              <CardContent className="p-6">
                ...
                <p className="text-slate-600 mb-4">
                  Connect with other learners, ask questions, and participate in
            ...
            <Card className="card-hover">
              <CardContent className="p-6">
                ...
                <p className="text-slate-600 mb-4">
                  Real-time access to government schemes, market prices, weather
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 text-white">
            ...
            <p className="text-xl text-emerald-100 mb-8">
              Join thousands of rural learners accessing government schemes and
