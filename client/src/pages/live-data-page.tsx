...
export default function LiveDataPage() {
  ...
  const categories = [
    ...
    { id: "education", label: "Education", icon: Home },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <TabsContent value="education" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Recent Education Schemes</CardTitle>
              </CardHeader>
              <CardContent>
                ...
                {(!schemes ||
                  schemes.filter((s) => s.category === "education").length ===
                    0) && (
                  <div className="text-center py-8">
                    <p className="text-slate-600">
                      No education schemes available at the moment.
                    </p>
                  </div>
                )}
              </CardContent>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
                ...
                <CardContent className="space-y-4">
                  <div className="p-4 bg-green-50 rounded-lg">
                    ...
                    <p className="text-green-700 text-sm">
                      Access your bank account online, transfer money, and pay
                      bills digitally.
                    </p>
                  </div>
                  <div className="p-4 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-blue-700 text-sm">
                      Send and receive money instantly using UPI apps like GPay,
                      PhonePe, and Paytm.
                    </p>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  >
                    <a
                      href="https://www.unionbankofindia.co.in"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <ExternalLink className="h-4 w-4 mr-2" />
