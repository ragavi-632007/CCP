...
export default function AdminDashboard() {
  ...
  const recentUsers = [
    ...
    { id: "2", name: "Sita ram", timeAgo: "4 hours ago", initials: "SA" },
    { id: "3", name: "Raj Kumaran", timeAgo: "6 hours ago", initials: "RK" },
    { id: "4", name: "Priya Devi", timeAgo: "8 hours ago", initials: "PD" },
  ];
